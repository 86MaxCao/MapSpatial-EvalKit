from models.sensenova_si.bagel import SenseNovaSIBagelModel
from models.sensenova_si.internvl import SenseNovaSIInternVLModel
from models.sensenova_si.qwen import SenseNovaSIQwenModel
