...
from models.sensenova_si.bagel_utils.modeling.cache_utils.taylorseer import (
    cal_type,
    derivative_approximation,
    taylor_cache_init,
    taylor_formula,
)
from models.sensenova_si.bagel_utils.modeling.qwen2.configuration_qwen2 import Qwen2Config as _Qwen2Config
from models.sensenova_si.bagel_utils.modeling.qwen2.modeling_qwen2 import (
    Qwen2Attention,
    Qwen2MLP,
