    ...
    def from_pretrained(
        ...
        try:
            ...
            try:
                ...
                print(f"[LatentUM] Loaded tokenizer from {tokenizer_source} (slow)")
            except (ValueError, TypeError):
                model.tokenizer = PreTrainedTokenizerFast.from_pretrained(
                    tokenizer_source,
                    trust_remote_code=True,
                )
                print(f"[LatentUM] Loaded tokenizer from {tokenizer_source} (PreTrainedTokenizerFast)")
