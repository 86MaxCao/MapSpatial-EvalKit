...
sys.path.append("src/qwenvl/external")
...
class Aggregator(nn.Module):
    ...
    def forward(self, images: torch.Tensor) -> Tuple[List[torch.Tensor], int]:
        ...
        mean = self._resnet_mean.to(device=images.device, dtype=images.dtype)
        std  = self._resnet_std .to(device=images.device, dtype=images.dtype)
