...
# [MapSpatial-EvalKit] Changed from: from .modeling.bagel.qwen2_navit import NaiveCache
# NaiveCache is in the vendored bagel modeling code
from ..bagel.modeling_bagel import NaiveCache
